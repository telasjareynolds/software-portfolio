  ...
  return (
    <div className="ebook">
      ...
      <p className="ebook__bio">
        ...
        you’re curious, but I’m sharing it here to show how life’s quirks—and a
        knack for structure—fuel my passion for creating meaningful tech.
      </p>
      </div>
      <a href="" className="ebook__link"></a>
    </div>
  );
}
